            ...
            ->addColumn('action', function ($query) {
                if ($query->status == 1) {
                    if (canAccess(['pengurus update'])) {
                        $update = '
                            <li>
                                <a class="dropdown-item border-bottom" href="' . route('admin.admin.edit', $query) . '">
                    ...
                    if (canAccess(['pengurus delete'])) {
                        $delete = '
                            <li>
                                <a class="dropdown-item border-bottom delete_item" href="' . route('admin.admin.destroy', $query) . '">
                    ...
                    if (canAccess(['pengurus restore'])) {
                        $restore = '
                            <li>
                                <a class="dropdown-item border-bottom" href="' . route('admin.admin.restore', $query) . '">
