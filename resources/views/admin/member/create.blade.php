...
@section('section_header_breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Menambah Data Anggota Koperasi') }}</li>
@endsection
                    ...
                    <div class="flex-wrap card-header d-flex align-items-center flex-xxl-nowrap">
                        <div class="flex-fill">
                            <div class="card-title">
                                {{ __('Menambah Data Anggota Koperasi') }}
                                <p class="subtitle text-muted fs-12 fw-normal">
                                    {{ __('Silahkan input data untuk proses menambah data anggota koperasi') }}
                                </p>
                            </div>
                        </div>
                        <div class="d-flex">
