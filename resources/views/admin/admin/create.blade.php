...
@section('section_header_breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('admin.admin.index') }}" class="text-white-50">
            {{ __('Pengurus Koperasi') }}
        </a>
    </li>
    <li class="breadcrumb-item active" aria-current="page">{{ __('Menambah Data Pengurus Koperasi') }}</li>
@endsection
                    ...
                    <div class="flex-wrap card-header d-flex align-items-center flex-xxl-nowrap">
                        <div class="flex-fill">
                            <div class="card-title">
                                {{ __('Menambah Data Pengurus Koperasi') }}
                                <p class="subtitle text-muted fs-12 fw-normal">
                                    {{ __('Silahkan input data untuk proses menambah data pengurus koperasi') }}
                                </p>
                            </div>
                        </div>
                        <div class="d-flex">
                        ...
                        <div class="mb-4 row gy-4">
                            <div class="col-xl-12">
                                ...
                                <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik"
                                    value="{{ old('nik') }}" placeholder="{{ __('NIK Anggota') }}" required autofocus>
                                @error('nik')
                        ...
                        <div class="mb-4 row gy-4">
                            <div class="col-xl-12">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ old('name') }}" placeholder="{{ __('Nama Anggota') }}"
                                    required>
                                @error('name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="join_date"
                                        value="{{ old('join_date') ?? date($setting_system['default_date_format']) }}"
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="start_work_date" value="{{ old('start_work_date') }}"
                        ...
                        <div class="mb-4 row gy-4">
                            <div class="col-xl-6">
                                ...
                                <input type="number"
                                    ...
                                    name="simpanan_pokok" id="simpanan_pokok" value="{{ old('simpanan_pokok') ?? 0 }}"
                            ...
                            <div class="col-xl-6">
                                ...
                                <input type="number"
                                    ...
                                    name="simpanan_wajib" id="simpanan_wajib" value="{{ old('simpanan_wajib') ?? 0 }}"
                        ...
                        <div class="mb-4 row gy-4">
                            ...
                            <div class="col-xl-6">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('simpanan_sukarela_tetap') ?? 0 }}"
