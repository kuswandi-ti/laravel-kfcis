...
@section('section_header_breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Menambah Data Periode') }}</li>
@endsection
                    ...
                    <div class="flex-wrap card-header d-flex align-items-center flex-xxl-nowrap">
                        <div class="flex-fill">
                            <div class="card-title">
                                {{ __('Menambah Data Periode') }}
                                <p class="subtitle text-muted fs-12 fw-normal">
                                    {{ __('Silahkan input data untuk proses menambah data periode') }}
                                </p>
                            </div>
                        </div>
                        <div class="d-flex">
                        ...
                        <div class="mb-4 row gy-4">
                            <div class="col-xl-12">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ old('name') }}" placeholder="{{ __('Periode') }}" required
                                    autofocus>
                                @error('name')
